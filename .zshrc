...
alias integrated_mode="systemctl start nvidia-persistenced.service && supergfxctl -m integrated"# Set personal aliases, overriding those provided by oh-my-zsh libs,
